...
func DatabaseConnection(){
	host,port,dbuser,dbpassword,dbname := os.Getenv("HOST"),os.Getenv("PORT"),os.Getenv("DBUSER"),os.Getenv("DBPASSWORD"),os.Getenv("DBNAME")
	postgresqlDbInfo := fmt.Sprintf("host=%s port=%s user=%s password=%s dbname=%s sslmode=disable", host, port, dbuser, dbpassword, dbname)
